    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <a href="{{ route('admin.course-format.create') }}" class="btn btn-success mb-3">Add Data</a>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Course Format</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            ...
                                            <a href="{{ route('admin.course-format.edit', $data->id) }}"
                                                class="btn btn-info btn-sm"><i class="bi bi-pen"></i> Edit</a>

                                            <form action="{{ route('admin.course-format.destroy', $data->id) }}"
