            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(auth()->user()->role === 'student')
                        <!-- Attendance Form for Student -->
                        <form action="{{ route('student.attendance.store', $course) }}" method="POST" id="attendance-form">
                            @csrf
                    ...
                    @if(auth()->user()->role === 'Admin')
                        ...
                        <a href="{{ route('student.attendance.download', ['date' => request('date'), 'role' => request('role'), 'course' => request('course')]) }}" class="btn btn-success mt-3">Download Report</a>
                    @endif
                </div>
            </div>
        </div>
