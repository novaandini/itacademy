    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Instructor Validation</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Instructor Validation</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Instructor Validation</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($category == 'pending')
                                                <a href="{{ route('admin.instructor.show', $data->id) }}" class="btn btn-info btn-sm">View</a>
                                            @else 
